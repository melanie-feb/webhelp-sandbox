                    ...
                    for(let i = 0; i<prodArr.length; i++) {
                       ...
                       let re = new RegExp(prodName, "g");
						...
						if(re.test(prodArr[i])) {
							...
							alert("The URL of home page for this product is not found, please check PROD_LANDPAGE_URL in Config.js");
						}
					}
                    //alert(matchedStr);
...
function insertTags() {	
            ...
            let htmlstr = "<div id=\"vrnban\" class=\"banner\"><div class=\"banner_content\"><div class=\"banner_text\">Reminder: You are not viewing the latest version. <a id=\"verID\" href=\"\"><strong>Click here to go to latest.</strong></a></div></div></div>";
